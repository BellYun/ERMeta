    ...
    sections: [
      {
        title: "집계 기준",
        items: [
          "패치 버전, 랭크 티어, 캐릭터, 무기 조합을 기준으로 경기 수와 성과 지표를 묶습니다.",
      ...
      },
      {
        title: "주요 지표 해석",
        items: [
          "승률은 해당 캐릭터 또는 무기 선택이 1위를 기록한 비율입니다. 이터널리턴 스쿼드 환경에서는 12.5% 전후를 기준선으로 해석합니다.",
      ...
      },
      {
        title: "패치 비교",
        items: [
          "패치 비교는 동일 캐릭터와 동일 무기 조건에서 이전 패치 대비 승률, 평균 RP, 픽률 변화를 확인합니다.",
          "버프 직후의 상승은 패치 효과와 플레이어 숙련도 변화가 함께 섞일 수 있으므로, 단일 지표보다 여러 지표를 함께 봅니다.",
          "캐릭터 패치 노트와 통계 변화를 같은 화면에 배치해 숫자의 원인을 추적할 수 있게 합니다.",
        ],
      },
      {
        title: "한계",
        items: [
          ...
          "표본이 작은 캐릭터, 무기, 조합은 실제 성능보다 높거나 낮게 보일 수 있습니다.",

    ...
    <article className="prose-custom max-w-3xl mx-auto py-8">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-[var(--color-muted-foreground)] leading-relaxed">
          ...
          원칙적으로 이용자의 개인정보를 수집하지 않습니다. 다만, 서비스 개선 및 이용 통계 분석을
          위해 아래와 같은 정보가 자동으로 수집될 수 있습니다.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-[var(--color-muted-foreground)] leading-relaxed mb-3">
          본 서비스는 이용 통계 분석을 위해 다음 도구를 사용하며, 각 도구는 쿠키를 통해 익명화된
          이용 데이터를 수집합니다.
        </p>
        ...
        <p className="text-sm text-[var(--color-muted-foreground)] leading-relaxed mt-3">
          이용자는 브라우저 설정을 통해 쿠키 저장을 거부할 수 있으며, 이 경우 서비스 이용에는 영향이
          없습니다.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-[var(--color-muted-foreground)] leading-relaxed">
          ...
          수집하는 개인정보는 없으므로 회원 탈퇴 등의 절차는 해당하지 않습니다.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-[var(--color-muted-foreground)] leading-relaxed">
          ...
          제공사(Google, Vercel, Amplitude)의 서버에 익명화된 통계 데이터가 전송될 수 있으며, 각
          서비스의 개인정보처리방침을 따릅니다.
        </p>
      </section>

  ...
  ko: {
    ...
    sections: [
      ...
      },
      {
        title: "제2조 (서비스의 내용)",
        body: [
          "서비스는 이터널리턴(Eternal Return) 게임의 공개 API 데이터를 기반으로 캐릭터 통계, 티어 분석, 조합 데이터 등의 정보를 제공합니다.",
        ],
        items: [
          "캐릭터별 승률, 픽률, 평균 RP 등 통계 정보",
      ...
      },
      {
        ...
        danger: true,
        body: [
          "본 서비스는 Nimble Neuron의 공식 서비스가 아닌 팬 제작 비공식 서비스입니다. 게임 관련 이미지, 캐릭터명, 아이템명 등의 권리는 Nimble Neuron에 있으며, 본 서비스는 Open API 이용 조건에 따라 운영됩니다.",
        ],
      },
      {
        title: "제4조 (데이터 정확성)",
      ...
      {copy.sections.map((section) => (
        <section key={section.title} className="mb-8">
          ...
          <div
            className={
              section.danger
                ? "rounded-lg border border-[var(--color-danger)]/30 bg-[var(--color-danger)]/5 p-4"
                : undefined
            }
          >

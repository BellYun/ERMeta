...
const copy = {
  ko: {
    ...
    lead: "이리와지지(ER&GG)는 이터널리턴 랭크 데이터를 바탕으로 실험체 메타, 무기 선택, 3인 조합 흐름을 읽기 쉽게 정리하는 비공식 분석 서비스입니다.",
    sections: [
      {
        title: "무엇을 제공하나요?",
        body: "단순 승률 목록만 보여주는 대신, 픽률, 승률, 평균 RP, 패치 전후 변화, 무기별 성과를 함께 비교합니다. 사용자는 특정 실험체가 강한지뿐 아니라 표본이 충분한지, 어떤 무기에서 성과가 나는지, 이전 패치 대비 흐름이 바뀌었는지를 한 화면에서 확인할 수 있습니다.",
      },
      {
        title: "데이터 출처",

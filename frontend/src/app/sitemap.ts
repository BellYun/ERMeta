...
import { buildSeoAlternateLanguages, prefixSeoLocalePath } from "@/lib/seoLocales";
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const localizedStaticPages: MetadataRoute.Sitemap = [
    {
      url: `${base}${prefixSeoLocalePath("/", "ja")}`,
      lastModified: now,
    ...
    {
      url: `${base}${prefixSeoLocalePath("/synergy", "ja")}`,
      lastModified: now,
      changeFrequency: "daily",
      priority: 0.7,
    ...
    {
      url: `${base}${prefixSeoLocalePath("/synergy-detail", "ja")}`,
      lastModified: now,
      changeFrequency: "daily",
      priority: 0.65,
    ...
    {
      url: `${base}${prefixSeoLocalePath("/patches", "ja")}`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.65,
    ...
    {
      url: `${base}${prefixSeoLocalePath("/season10-recap", "ja")}`,
      lastModified: now,
      changeFrequency: "weekly",
      priority: 0.7,

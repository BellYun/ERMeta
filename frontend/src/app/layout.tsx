...
export const metadata: Metadata = {
  ...
  title: {
    default: "LumiaStats - 이터널리턴 메타 분석",
    template: "%s | LumiaStats",
  },
  description: "이터널리턴(Eternal Return) 캐릭터 티어, 3인 조합 추천, 승률·픽률·평균 RP 통계 분석 서비스. 다이아~상위 1000위 데이터 기반.",
  keywords: [
    "이터널리턴", "Eternal Return", "이터널리턴 티어표", "이터널리턴 메타",
    "이터널리턴 조합 추천", "이터널리턴 캐릭터 분석", "이터널리턴 승률",
    "이터널리턴 픽률", "이터널리턴 RP", "LumiaStats",
  ],
  authors: [{ name: "LumiaStats" }],
  creator: "LumiaStats",
  openGraph: {
    type: "website",
    locale: "ko_KR",
    url: BASE_URL,
    siteName: "LumiaStats",
    title: "LumiaStats - 이터널리턴 메타 분석",
    description: "이터널리턴 캐릭터 티어, 3인 조합 추천, 승률·픽률·평균 RP 통계 분석 서비스.",
  },
  twitter: {

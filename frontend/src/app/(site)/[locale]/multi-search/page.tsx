...
> = {
  ko: {
    ...
    description:
      "이터널리턴 팀원 닉네임 3개를 동시에 검색해 시즌 39 랭크, MMR, 승률, 순방률, 주력 실험체를 확인합니다.",
    kicker: "시즌 39 기준",
    subtitle: "닉네임 3개를 동시에 검색해 현재 시즌 랭크 지표와 주력 실험체를 비교합니다.",
    body: "BSER 공식 API 기반으로 MMR, 순위, 승률, 순방률, 실험체별 기록을 정리합니다.",

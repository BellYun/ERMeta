...
const COPY = {
  ko: {
    title: "실험체 유형 분석",
    metadataTitle: "실험체 유형 분석 - 시너지 그룹",
    description:
      "이터널리턴 실험체를 시즌 10·11에서 실제 RP가 높았던 파트너 역할 조합별로 묶어 보여줍니다.",
    kicker: "시즌 10·11 조합 적합도",
    subtitle:
      "실험체마다 RP 상승과 실제 판수 경향을 함께 반영해 잘 맞는 두 역할 조합을 찾았습니다.",
    ...
    compositionLinkTitle: "실험체 조합 분석",
    compositionLinkBody: "역할 조합을 고정하고 내부 역할군과 추천 실험체를 다시 비교합니다.",
  },
  en: {
    title: "Role Groups",
...
> = {
  ko: {
    ...
    allTypesTitle: "모든 실험체 유형",
    allTypesBody: "6개 역할의 조합 적합군, 내부 역할군, 소속 실험체를 한 화면에 모두 표시합니다.",
    outerGroups: "조합 적합군",
    internalTypes: "내부 유형",
    profiles: "프로필",
    characters: "소속 실험체",

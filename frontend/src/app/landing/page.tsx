...
const FEATURES = [
  {
    ...
    title: "메타 분석",
    description:
      "패치별 캐릭터 티어표, 승률·픽률·평균 RP를 한눈에. 이번 패치 떡상 캐릭터도 놓치지 마세요.",
    badge: "실시간",
    href: "/",
  },
  {
  ...
  },
  {
    ...
    title: "캐릭터 분석",
    description:
      "특성·장비 빌드, 코어 아이템 완성도, 게임 길이별 성과까지. 내 캐릭터를 깊이 파헤쳐 보세요.",
    badge: "딥다이브",
    href: "/character/1",
  },
];
...
const DIFFERENTIATORS = [
  {
    title: "실전 데이터만",
    description:
      "다이아몬드~상위 1000위 고티어 매칭 데이터만 수집합니다. 낮은 티어 노이즈 없이 진짜 메타를 보여드려요.",
  },
  {
    title: "패치 단위 추적",
    description:
      "패치가 바뀔 때마다 자동으로 새 데이터를 수집하고 비교합니다. 이전 패치 대비 변화를 한눈에 확인하세요.",
  },
  {
    title: "3인 조합 시너지",
    description:
      "단순 캐릭터 순위가 아닌, 실제 함께 플레이할 때의 시너지를 분석합니다. 팀 게임에 맞는 추천을 제공합니다.",
  },
];
      ...
      <section className="relative px-4 pt-16 pb-20 sm:pt-24 sm:pb-28 overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto text-center flex flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="h-12 w-12 rounded-2xl bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-accent-purple)] flex items-center justify-center text-lg font-black text-white shadow-[0_18px_36px_-28px_rgba(24,34,48,0.18)]">
              ER
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 mt-2">
            <Link href="/">
              <Button
                size="lg"
                className="px-8 text-base font-semibold shadow-[0_16px_32px_-24px_rgba(24,34,48,0.16)]"
              >
                메타 분석 보기
              </Button>
            </Link>
          ...
          <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
            {FEATURES.map((feature) => (
              <Link key={feature.title} href={feature.href}>
                <Card className="h-full group hover:border-[var(--color-primary)]/30 hover:shadow-[0_18px_34px_-28px_rgba(24,34,48,0.18)] transition-all duration-300 cursor-pointer">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <div className="relative flex flex-col items-center gap-5">
            ...
            <p className="text-sm text-[var(--color-muted-foreground)] max-w-md">
              매 패치마다 자동 업데이트되는 실전 데이터. 북마크 해두고 패치 때마다 확인하세요.
            </p>
            <Link href="/">
              <Button
                size="lg"
                className="px-10 text-base font-semibold shadow-[0_16px_32px_-24px_rgba(24,34,48,0.16)]"
              >
                지금 시작하기
              </Button>
            </Link>

...
import { getPatch123MasteryChanges } from "./12.3-weapon-mastery";
...
export const PATCH_NOTES: CharacterPatchNote[] = [
  ...
  },
  {
    ...
    patch: PATCH,
    changes: [...getPatch123MasteryChanges(74, 3)],
  },
  {
    characterCode: 69, // 레니
    patch: PATCH,
  ...
  },
  {
    characterCode: 13, // 쇼우
    patch: PATCH,
    changes: [...getPatch123MasteryChanges(13, 19)],
  },
  {
  ...
  },
  {
    ...
    patch: PATCH,
    changes: [
      ...getPatch123MasteryChanges(1, 15),
      ...getPatch123MasteryChanges(1, 16),
      ...getPatch123MasteryChanges(1, 14),
      ...getPatch123MasteryChanges(1, 18),
      {
  ...
  },
  {
    characterCode: 23, // 캐시
    patch: PATCH,
    changes: [...getPatch123MasteryChanges(23, 18)],
  },
  {
  ...
  },
  {
    characterCode: 12, // 혜진
    patch: PATCH,
    changes: [...getPatch123MasteryChanges(12, 7)],
  },
  {

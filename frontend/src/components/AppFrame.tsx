      ...
      <div className="app-canvas min-h-screen overflow-x-clip bg-[var(--color-background)]">
        <div className="min-w-0 flex flex-col">
          ...
          <div
            className={
              showRailAds
                ? "app-layout mx-auto grid w-full max-w-[1720px] grid-cols-1 gap-4 px-3 pt-4 pb-8 sm:px-4 sm:pt-5 sm:pb-10 lg:px-6 lg:pt-5 lg:pb-8 min-[1280px]:grid-cols-[178px_minmax(0,1fr)] min-[1700px]:grid-cols-[178px_minmax(0,1fr)_178px]"

...
const TRAIT_CODES_WITHOUT_ICON = new Set<number>();

export function hasTraitIcon(code: number): boolean {
  return !TRAIT_CODES_WITHOUT_ICON.has(code);
}
...
export const TRAIT_CORES: Record<TraitGroup, number[]> = {
  ...
  support: [7211301, 7200201, 7200301, 7200501],
  chaos: [7300101, 7300201, 7000501, 7300301],
  unknown: [],
};
...
export const TRAIT_SUBS_SLOT1: Record<TraitGroup, number[]> = {
  ...
  support: [7211001, 7210101, 7211401, 7200101],
...
export const TRAIT_SUBS_SLOT2: Record<TraitGroup, number[]> = {
  ...
  chaos: [7310101, 7310301, 7310501, 7310701],
  unknown: [],
};

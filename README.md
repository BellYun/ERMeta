...
| 페이지 캐싱    | 주요 정적 경로 Edge Cache 적중률 **98.4~99.8%** | 88개 캐릭터 정적 생성 · 메인 ISR            |
...
> 수치는 실제 서비스 운영 및 대표 조회 시나리오에서 측정한 값입니다. 캐시 적중률은 주요 정적 경로, DB·응답시간 개선율은 3인 조합 대표 조회를 기준으로 합니다.
...
- 주요 정적 경로에서 **Edge Cache 적중률 98.4~99.8%**를 확인했습니다.
...
### 4. 일본 사용자 진입을 위한 locale 기반 라우팅·SEO

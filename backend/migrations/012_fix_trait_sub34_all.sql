-- ============================================================
-- 012: sub3/sub4/optionTrait3/optionTrait4 완전 제거
-- 대상: 테이블 컬럼 + upsert 함수 + process_game_v2 함수
-- Supabase Dashboard → SQL Editor에서 실행
-- ============================================================

BEGIN;

-- ── 1. 테이블 컬럼 제거 (이미 없으면 무시) ──
...
-- ── 3. upsert 함수 재정의 (sub3/sub4/optionTrait3/optionTrait4 제거) ──
...
-- ── 4. process_game_v2 재정의 (sub3/sub4 제거) ──

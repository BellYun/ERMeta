-- ============================================================
-- 015: v2_CharacterItemPriority / v2_CharacterSkillOrder 적재 범위를 10.7+
-- 목적:
--   - 백필/수집이 계속 돌아도 10.7 미만 patch_version 데이터가
--     ItemPriority / SkillOrder 테이블에 다시 쌓이지 않도록 차단
-- 주의:
--   - 기존 10.7 미만 row 삭제는 별도 작업으로 분리한다.
--   - 현재 디스크/WAL 압박 상황에서는 대량 DELETE가 오히려 부담일 수 있다.
-- ============================================================
